...
Examples to illustrate these modes are provided in {{sec-appendix}}.
...
This section provides examples to illustrate the distribution of the metrics. These examples are not deployment recommendations.
